...
describe('Convert To Human Time', () => {
  it('convert should exist', () => expect(convertToHumanTime).to.exist);
  ...
  // 71000 ms = 1:11
  it('should receive 71000ms and convert to 1:11', () => {
    expect(convertToHumanTime(71000)).to.be.equal('1:11');
  });
});
